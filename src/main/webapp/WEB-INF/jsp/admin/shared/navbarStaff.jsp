...
<li class="nav-item"><a href="<spring:url value="/gallery/indexStaff" htmlEscape="true"/>"><i class="fa fa-photo"></i> Galerie</a></li>
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a href="<spring:url value="/clients/indexStaff" htmlEscape="true"/>"><i class="fa fa-user"></i> Klienti</a></li>
