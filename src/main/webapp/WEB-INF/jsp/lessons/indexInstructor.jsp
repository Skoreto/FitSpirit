                ...
                <td>
                	<c:choose>
						<c:when test="${lesson.active}">
	                        <c:choose>
								<c:when test="${lesson.instructor.id == loggedInUser.id && lesson.actualCapacity == lesson.originalCapacity}">
		                            <div class="btn-group">
...
<a href="<spring:url value="/lessons/create" htmlEscape="true"/>" class="btn btn-default pull-right">Přidat lekci</a>
